...
int worst_fit(Particion particiones[], int n, int tam_proceso) {
    /* TODO:
     * 1. Declare una variable "peor_indice" inicializada en -1 y
     *    "peor_tamano" inicializada en 0.
     * 2. Recorra todas las particiones.
     * 3. Si esta LIBRE y su tamano >= tam_proceso Y es mayor que
     *    "peor_tamano" encontrado hasta ahora, actualice peor_indice
     *    y peor_tamano.
     * 4. Al terminar el recorrido, retorne peor_indice.
     */
...
int next_fit(Particion particiones[], int n, int tam_proceso) {
    ...
    for (contador = 0; contador < n; contador++) {
        int indice = (puntero_next_fit + contador) % n;
